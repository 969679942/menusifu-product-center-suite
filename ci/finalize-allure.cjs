...
const businessRoot=path.join(out,'business'),rawDir=path.join(out,'allure-results'),businessDir=path.join(out,'allure-results-business'),technicalDir=path.join(out,'allure-results-technical');
