...
test('suite configuration passes MC-only identity and TAP boundary gate', () => {
  ...
  assert.equal(suite.platform.role, 'contract-package-and-result-analyzer');
  assert.equal(suite.platform.sourceRoot, 'package:@menusifu/tap-contract@1.1.3');
