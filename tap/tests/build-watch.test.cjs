...
const build = {buildNumber:7, gitSha:'a'.repeat(40), requestId:'request-7', building:false};
...
test('stale, incomplete and repair-pending reviews cannot close current work',()=>{
  for(const patch of [{gitSha:'b'.repeat(40)},{requestId:'other'},{evidence:[]},{conclusion:''},{actionRequired:'repair'}]) {
