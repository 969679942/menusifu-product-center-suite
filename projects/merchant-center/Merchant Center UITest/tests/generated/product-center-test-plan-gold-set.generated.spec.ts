...
import recipesDocument from '../../contracts/product-center/recipes/product-center-test-plan-gold-set-recipes.json';
  ...
  for (const recipe of recipes) {
    test(
      ...
      async ({ page, productCenterApi, cleanupRegistry, executionLedger }, testInfo) => {
        ...
        await test.step('按金标集 Recipe 执行真实 UI 与 API 验证', async () => {
