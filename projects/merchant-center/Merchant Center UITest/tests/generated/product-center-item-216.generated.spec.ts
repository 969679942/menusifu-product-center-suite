...
export const item216FormalCaseInventory = [
  ...
  },
  {
    ...
    "title": "同一商户同一商品类型内新建同名商品创建失败",
    "conversionScope": "executable"
  },
  {
    "caseId": "TC-ITEM-STD-012",
    "title": "同一商品类型不同二级分类的标准商品同名提示 BITEM-7014",
    "conversionScope": "executable"
  },
  {
    "caseId": "TC-ITEM-STD-013",
    "title": "同一商品类型同一二级分类下新建同名商品创建失败",
    "conversionScope": "executable"
  },
  {
    "caseId": "TC-ITEM-STD-014",
    "title": "同一商户同一商品类型下不同一级分类仍不可创建同名商品",
    "conversionScope": "executable"
  },
  {
  ...
  },
  {
    ...
    "title": "同一商户同一商品类型内商品名称重复时创建或编辑失败",
    "conversionScope": "executable"
  },
  {
  ...
  },
  {
    ...
    "title": "同一商户同一商品类型内套餐商品同名创建失败",
    "conversionScope": "executable"
  },
  {
    "caseId": "TC-ITEM-PKG-025",
    "title": "套餐商品同商户同类型同名创建或编辑失败",
    "conversionScope": "executable"
  },
  {
  ...
  },
  {
    ...
    "title": "套餐商品编辑页可选搭配组仅支持组级操作并验证持久化",
    "conversionScope": "executable"
  },
  {
  ...
  },
  {
    ...
    "title": "同一商户同一商品类型内加料商品同名创建或编辑失败",
    "conversionScope": "executable"
  },
  {
  ...
  {
    "caseId": "TC-ITEM-STD-102",
    "title": "商品名称恰好100字符且包含单个中间空格时允许保存",
    "conversionScope": "executable"
  },
  {
    "caseId": "TC-ITEM-STD-103",
    "title": "商品名称包含 emoji 时保存失败",
    "conversionScope": "executable"
  }
] as const;
const allCases = [
...
const supplementalCaseIds: Set<string> = new Set<string>([]);
