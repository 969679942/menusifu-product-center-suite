...
} from '../../../../../tap/src/automation/system-test/business-rule-coverage';
...
export function buildProductCenterRuleCoverage(input: {
  ...
  currentIdentities?: import('../../../../../tap/src/automation/system-test/business-rule-coverage').BusinessRuleCoverageCurrentIdentity[];
  currentEvidence?: import('../../../../../tap/src/automation/system-test/business-rule-coverage').BusinessRuleCoverageEvidence[];
