...
- 4h62hherct59574922865ac6rb：4. 商品列表页面区域分为2块 左侧区域为：后台分类 右侧区域为：商品列表 4.2 分类树形结构展示，支持到三级树形结构，每一级的分类下有功能按钮：新增 修改删除 4.3 分类和商品都有查询框，默认查询条件为空，商品查询支持 商品名 商品分类 标签 商品状态等条件查询 4.4. 商品列表页展示所有的商品，一页展示20条数据，可更改为一页展示50或者100条 4.5 商品列表默认展示全部的商品，按照商品的创建顺序，后创建的展示在最上面 4.6 - 列表字段 - 选择：可多选商品 - 图片：商品主体第一张 - 商品名称（中英文） - 商品类型：单品、套餐、配菜/加料 - 后台分类 - 标准价 - 状态：可售、禁售 - 更新时间 - 操作：编辑、删除、停售/启售；already-covered；匹配=TC-ITEM-ADD-024, TC-ITEM-ADD-025, TC-ITEM-ADD-026, TC-ITEM-ADD-036, TC-ITEM-ADD-040
...
- 498k863f58s7d5u5game0kl1l1：一级分类下有商品，不可创建二级分类；already-covered；匹配=TC-ITEM-STD-035
- 083vafg5nagslgj3perchpakvi：6.1 新增成功，输入字符自动格式化前100个有效字符，首尾空格去掉 中间连续多个空格格式化到1个空格，只保留中文数字 英文特殊字符自动去掉 7. 数据库中存储的字符信息与格式化之后的信息一致 =====；already-covered；匹配=TC-ITEM-STD-091, TC-ITEM-STD-094
- 51kohmbuel2m89cq1o5ghpbgcn：6.1 新增成功，输入字符自动格式化前100个有效字符，首尾空格去掉 中间连续多个空格格式化到1个空格，只保留中文数字 英文特殊字符自动去掉 7. 数据库中存储的字符信息与格式化之后的信息一致 =====；already-covered；匹配=TC-ITEM-ADD-013, TC-ITEM-PKG-022
...
- 1c57lr35i0l42fsinn29vpgqs9：6. 提交成功,类A/A1下新增一条商品记录，展示在该二级分类商品的最上面，标准价格为1.99，图片展示商品的主图的信息 8. 数据库中的字段信息与输入的一致；already-covered；匹配=TC-ITEM-STD-020
- 58i9s3djnu77jq7g47sqft1s4j：6. 提交失败，提示价格输入格式不正确；already-covered；匹配=TC-ITEM-STD-020, TC-ITEM-STD-024
- 3qarp9la09jlrdu9l44je520qg：6. 非数字提交失败，0保存之后恢复默认值1；already-covered；匹配=TC-ITEM-PKG-014, TC-ITEM-PKG-015, TC-ITEM-STD-040
- 5o8vmoq5gv665l3orl4g7msimu：6. 提交成功 ==== 7. 默认的点单页面的数量为2，且不可减少为1；already-covered；匹配=TC-ITEM-STD-024
- 5o94ihj2pb7cgcn317dt0nq36h：从行业商品库选择商品可继承行业商品库的信息，后进行编辑，继承过来的口味/口味等信息同步更新；already-covered；匹配=TC-ITEM-STD-034
- 29iqa2q9v8vkrikfobg8oa4ejr：基础信息编辑；already-covered；匹配=TC-ITEM-STD-031
- 3ltg95bv8ntgussasn5ve7tf5s：商品属性编辑；already-covered；匹配=TC-ITEM-ADD-032
- 23muoh9319l4s0a0hs9st7iegu：其他信息编辑；already-covered；匹配=TC-ITEM-STD-033
...
- cef9714d-5718-482b-b4cb-455ea22a79a3：基本信息与标准商品一致：包含：商品名称、商品第二名称、商品分类、商品描述、POS名称、送厨名称、助记码、商品编码、单位、起售数量：默认填充为1，商品价格与标准商品也一致：标准价和包装费；already-covered；匹配=TC-ITEM-STD-016, TC-ITEM-STD-017, TC-ITEM-ADD-001, TC-ITEM-ADD-002, TC-ITEM-ADD-016
- d4915574-fbe3-4bd8-a711-86ff0a8f8e65：默认加载为套餐组已创建的所有固定搭配类型；already-covered；匹配=TC-ITEM-PKG-002, TC-ITEM-PKG-003, TC-ITEM-PKG-004, TC-ITEM-PKG-040, TC-ITEM-PKG-041
- 07161af6-2669-4fad-a199-46042a6d0611：加载的套餐列表中的套餐组，加入右侧已选套餐，右侧已选套餐可移除选择的套餐组；already-covered；匹配=TC-ITEM-PKG-002, TC-ITEM-PKG-003, TC-ITEM-PKG-004, TC-ITEM-PKG-040, TC-ITEM-PKG-041
- 5f709e7b-1ac2-4f53-8f84-9564f1850846：支持模糊搜索，按名称精确搜索，删除输入的搜索条件按照默认搜索；already-covered；匹配=TC-ITEM-PKG-003, TC-ITEM-PKG-002, TC-ITEM-PKG-006, TC-ITEM-PKG-042, TC-ITEM-PKG-056
- c6637439-53d1-4017-aa77-9ae801657a09：未选择套餐组，确认按钮默认不可点击，选择套餐组后确认按钮高亮可点击，点击后退出当前选择页面返回创建套餐页面；already-covered；匹配=TC-ITEM-PKG-002, TC-ITEM-PKG-003, TC-ITEM-PKG-004, TC-ITEM-PKG-040, TC-ITEM-PKG-041
- 51485e31-4f5d-4bf7-81ef-8d40facb6d73：默认加载为套餐组已创建的所有组合搭配(可选搭配)类型；already-covered；匹配=TC-ITEM-PKG-002, TC-ITEM-PKG-003, TC-ITEM-PKG-004, TC-ITEM-PKG-040, TC-ITEM-PKG-041
- 4fd929e8-afed-4206-b634-5974aa46fb92：加载的套餐列表中的套餐组，加入右侧已选套餐，右侧已选套餐可移除选择的套餐组；already-covered；匹配=TC-ITEM-PKG-002, TC-ITEM-PKG-003, TC-ITEM-PKG-004, TC-ITEM-PKG-040, TC-ITEM-PKG-041
- e3431ee9-ba9f-467b-9e96-3747018cda91：支持模糊搜索，按名称精确搜索，删除输入的搜索条件按照默认搜索；already-covered；匹配=TC-ITEM-PKG-004, TC-ITEM-PKG-003, TC-ITEM-PKG-002, TC-ITEM-PKG-040, TC-ITEM-PKG-041
- b8523b81-5b0e-4718-b3cc-a6c7ffeebe51：未选择套餐组，确认按钮默认不可点击，选择套餐组后确认按钮高亮可点击，点击后退出当前选择页面返回创建套餐页面；already-covered；匹配=TC-ITEM-PKG-002, TC-ITEM-PKG-003, TC-ITEM-PKG-004, TC-ITEM-PKG-040, TC-ITEM-PKG-041
- b39cd334-fdac-44bb-b902-02174f217ca6：借鉴套餐组新增；already-covered；匹配=TC-ITEM-PKG-002, TC-ITEM-PKG-003, TC-ITEM-PKG-004, TC-ITEM-PKG-046
- 8ba41fbd-c73a-41bf-8443-d40e65c475e2：借鉴套餐组新增；already-covered；匹配=TC-ITEM-PKG-002, TC-ITEM-PKG-003, TC-ITEM-PKG-004
- ffb61056-78cf-4b0b-8228-5a04bbc05709：其他设置也与标准商品一致：可添加详情图片，描述标签，商品角标，统计标签，材料信息；already-covered；匹配=TC-ITEM-STD-016, TC-ITEM-STD-017, TC-ITEM-ADD-001, TC-ITEM-ADD-002, TC-ITEM-ADD-017
- 0649c441-e2e1-4dea-bad4-1815740fa9ef：基本信息与标准商品一致：包含：商品名称、商品第二名称、商品分类、商品描述、POS名称、送厨名称、助记码、商品编码、单位，商品价格与标准商品也一致：标准价和包装费和成本 注意：无起售数量；already-covered；匹配=TC-ITEM-STD-016, TC-ITEM-STD-017, TC-ITEM-ADD-001, TC-ITEM-ADD-002, TC-ITEM-ADD-016
- af2e2d99-5991-4b5f-8510-ddad5ffe79c8：其他设置也与标准商品一致：可添加详情图片，描述标签，商品角标，统计标签，材料信息；already-covered；匹配=TC-ITEM-STD-016, TC-ITEM-STD-017, TC-ITEM-ADD-001, TC-ITEM-ADD-002, TC-ITEM-ADD-017
