...
import { buildSystemTestCaseImplementationFingerprints } from '../../../../tap/scripts/run-system-test';
import { fingerprintSystemTestValue } from '../../../../tap/src/automation/system-test/system-test-contract';
import { buildProjectRemediationOptimizationPlan } from '../../../../tap/src/governance/project-remediation-optimization';
import type { ProjectRemediationScopeArtifact } from '../../../../tap/src/governance/project-remediation-scope';
import type { SystemTestOptimizationPlan, SystemTestOptimizationReceipt } from '../../../../tap/src/governance/system-test-optimization-gate';
...
import type { SystemTestRevalidationImpactType } from '../../../../tap/src/automation/system-test/system-test-revalidation-policy';
