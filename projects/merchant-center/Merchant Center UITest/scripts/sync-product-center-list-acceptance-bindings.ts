...
import {standardListSpecPath} from '../adapters/product-center/product-center-item-spec-routes';

export function syncListAcceptanceBindings(rootDir=process.cwd()) {
...
if(require.main===module)syncListAcceptanceBindings();
