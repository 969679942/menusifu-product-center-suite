...
import { assertSystemTestOptimizationGate, type SystemTestOptimizationPlan } from '../../../../tap/src/governance/system-test-optimization-gate';
...
} from '../../../../tap/src/governance/project-remediation-optimization';
...
import { assertExecutionIntentCheckpointState, assertExecutionIntentCompletion, assertExecutionIntentContract, type ExecutionIntent } from '../../../../tap/src/governance/execution-intent';
import { fingerprintImplementationSources } from '../../../../tap/src/automation/system-test/system-test-implementation-fingerprint';
import { inspectSystemTestRepairAttemptState } from '../../../../tap/src/automation/system-test/system-test-repair-attempt-guard';
