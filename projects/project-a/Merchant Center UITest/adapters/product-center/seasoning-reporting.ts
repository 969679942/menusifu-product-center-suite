...
const operationPurposes: Record<string, string> = {
  ...
  'ui:seasoning/read-created': '通过页面回读已创建的品牌调味',
  'ui:seasoning/read-updated': '通过页面回读品牌调味编辑结果',
  'ui:seasoning/read-absent': '通过页面确认品牌调味已不存在',
  'ui:click seasoning-edit-confirm': '点击确认保存品牌调味编辑',
  'ui:fill seasoning-option-51': '填写第 51 个调味项以验证数量边界',
